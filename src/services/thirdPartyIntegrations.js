 ...
 * Last Sync: 2025-12-19T23:29:57.628Z
 * 
...
class ThirdPartyIntegrations {
    constructor() {
        ...
        this.integrationTypes = {
            ci: ['github-actions', 'gitlab-ci', 'jenkins', 'circleci', 'azure-devops', 'travis-ci'],
    ...
    initializePlatformIntegration(integration) {
        switch (integration.platform) {
            ...
            case 'gitlab':
                if (integration.credentials.token && integration.credentials.projectId) {
    ...
    getAvailablePlatforms() {
        return {
            ...
            projectManagement: this.integrationTypes.projectManagement.map(platform => ({
                platform,
                name: this.getPlatformName(platform),
                status: 'available'
            }))
