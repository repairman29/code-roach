    ...
    constructor() {
        ...
        if (config.supabase.serviceRoleKey) {
            try {
                ...
                console.warn('[codeRoachAlerts] Supabase not configured:', error.message);
                this.supabase = null;
            }
        } else {
            console.warn('[codeRoachAlerts] Supabase credentials not configured. Service will be disabled.');
            this.supabase = null;
        }
    }
