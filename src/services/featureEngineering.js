...
class FeatureEngineering {
    ...
    extractAllFeatures(error, fix, context = {}) {
        ...
        const engineeredFeatures = {
            ...
            similarityComplexity: baseFeatures.patternSimilarity * baseFeatures.fixComplexity,
            historicalTemporal: baseFeatures.historicalSuccessRate * baseFeatures.temporalRecency,
            contextComplexity: baseFeatures.contextMatch * (1 - baseFeatures.fixComplexity),
