 ...
 * Last Sync: 2025-12-19T23:29:57.639Z
 * 
...
class SmartAlertService {
    ...
    initializeAlertRules() {
        ...
        this.alertRules.set('critical-pattern', {
            ...
            check: (error) => {
                const criticalKeywords = ['corruption', 'crash', 'data loss', 'security'];
    ...
    sendAlert(ruleId, context, details = {}) {
        ...
        // Log alert
        console.log(`🚨 [Code Roach Alert] ${rule.severity.toUpperCase()}: ${rule.message}`, details);
    ...
    checkAlerts(error = null, stats = null, learningStats = null) {
        ...
        if (learningStats) {
            if (this.shouldAlert('fix-quality-drop', learningStats)) {
                alerts.push(this.sendAlert('fix-quality-drop', learningStats, { learningStats }));
            }
        }
