 ...
 * Last Sync: 2025-12-20T22:26:03.339Z
 * 
    ...
    constructor() {
        ...
        if (config.supabase.serviceRoleKey) {
            try {
                ...
                console.warn('[customerOnboardingService] Supabase not configured:', error.message);
                this.supabase = null;
            }
        } else {
            console.warn('[customerOnboardingService] Supabase credentials not configured. Service will be disabled.');
            this.supabase = null;
        }
    }
